...
contract WalletSimple {
  ...
  // Public fields
  address[3] public signers; // The addresses that can co-sign transactions on the wallet
   ...
   * @param a3 the third address
   */
  function WalletSimple(address a1, address a2, address a3) public {
    signers = [a1, a2, a3];
  }
